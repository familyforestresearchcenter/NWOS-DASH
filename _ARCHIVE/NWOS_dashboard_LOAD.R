...
#loading estimates
et <- readRDS(paste(dir,"ESTIMATES/NWOS_2018_FFO_TENPLUS.RDS",sep=""))
et$DOMAIN <- "10+"
et$STRATUM <- "FFO"
et$YEAR <- "2018"
et$TNUM <- TNUM(et)

et2 <- readRDS(paste(dir,"ESTIMATES/NWOS_2018_FFO_HUNDREDPLUS.RDS",sep=""))
et2$DOMAIN <- "100+"
et2$STRATUM <- "FFO"
et2$YEAR <- "2018"
et2$TNUM <- TNUM(et2)

et3 <- readRDS(paste(dir,"ESTIMATES/NWOS_2018_FFO_ONEPLUS.RDS",sep=""))
et3$DOMAIN <- "1+"
et3$STRATUM <- "FFO"
et3$YEAR <- "2018"
et3$TNUM <- TNUM(et3)

et4 <- readRDS(paste(dir,"ESTIMATES/NWOS_2018_FFO_THOUSANDPLUS.RDS",sep=""))
et4$DOMAIN <- "1000+"
et4$STRATUM <- "FFO"
et4$YEAR <- "2018"
et4$TNUM <- TNUM(et4)
